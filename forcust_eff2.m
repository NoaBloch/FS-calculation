...
% eps0=8.854187817e-12; 
 ...
 L=0.2;
 omega0=10*1e-4;
 deff=(15e-12)*3e4/(4*pi); %ppktp d33
 Tvec=20:2:80;  %Temp scan in celsius 
 %lambda1=1.064e-4;%Pump wavelength
 lvec=(0.959:0.0001 :0.9615).*1e-4;  %Can be scanned in wavelength 
 P1 = 2000*1e7; % 1Watt = 1e7 erg/s  Pump power in Watt
...
%Pperiod=8.9462*1e-04;
 Pperiod=16.28e-4; %Pperiod of periodic poling
%Pperiod=0.12e-5;
